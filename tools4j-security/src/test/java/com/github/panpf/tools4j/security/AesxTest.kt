...
class AesxTest {
    ...
    fun testDefaultConfig() {
        ...
        val encryptResult = Aesx.encrypt(SOURCE.toByteArray(), Aesx.DEFAULT, key)
        val decryptResult = Aesx.decryptToString(encryptResult, Aesx.DEFAULT, key)
    ...
    fun testDefaultConfigWithBase64() {
        val key = Aesx.createKey(128)
        val encryptResult = Aesx.encryptToBase64(SOURCE.toByteArray(), Aesx.DEFAULT, key)
        val decryptResult = Aesx.decryptToStringFromBase64(encryptResult, Aesx.DEFAULT, key)
