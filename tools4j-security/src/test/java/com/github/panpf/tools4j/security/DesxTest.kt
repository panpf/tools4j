...
class DesxTest {
    ...
    fun testDefaultConfig() {
        ...
        val encryptResult = Desx.encrypt(SOURCE.toByteArray(), Desx.DEFAULT, key)
        val decryptResult = Desx.decryptToString(encryptResult, Desx.DEFAULT, key)
    ...
    fun testDefaultConfigWithBase64() {
        val key = Desx.createKeyByPassword(PASSWORD)
        val encryptResult = Desx.encryptToBase64(SOURCE.toByteArray(), Desx.DEFAULT, key)
        val decryptResult = Desx.decryptToStringFromBase64(encryptResult, Desx.DEFAULT, key)
