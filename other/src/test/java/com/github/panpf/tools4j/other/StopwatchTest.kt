...
class StopwatchTest {
    ...
    fun testCountLap() {
        ...
        Assert.assertTrue(firstCountLap.time in stopwatch.startTime + 1000L..stopwatch.startTime + 1010L)
        ...
        Assert.assertTrue(secondCountLap.time in stopwatch.startTime + 3000L..stopwatch.startTime + 3020L)
        Assert.assertTrue(secondCountLap.distanceLastTime in 2000L..2020L)
        Assert.assertTrue(secondCountLap.distanceStartTime in 3000L..3020L)
        Thread.sleep(3000L)
        val thirdCountLap = stopwatch.countLap()
        Assert.assertTrue(thirdCountLap.time in stopwatch.startTime + 6000L..stopwatch.startTime + 6030L)
        Assert.assertTrue(thirdCountLap.distanceLastTime in 3000L..3030L)
        Assert.assertTrue(thirdCountLap.distanceStartTime in 6000L..6030L)
    }
