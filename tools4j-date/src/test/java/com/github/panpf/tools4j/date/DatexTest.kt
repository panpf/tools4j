...
class DatexTest {
    ...
    fun testFormatDuration() {
        ...
        Assert.assertEquals("0毫秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s?秒%ms?毫秒"))
        Assert.assertEquals("0毫秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s?秒%ms毫秒"))
        Assert.assertEquals("0秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s秒%ms?毫秒"))
        Assert.assertEquals("0分钟", Datex.formatDuration(0L, "%d?天%h?小时%m分钟%s?秒%ms?毫秒"))
        Assert.assertEquals("0小时", Datex.formatDuration(0L, "%d?天%h小时%m?分钟%s?秒%ms?毫秒"))
        Assert.assertEquals("0天", Datex.formatDuration(0L, "%d天%h?小时%m?分钟%s?秒%ms?毫秒"))
        Assert.assertEquals("0秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s?秒"))
        Assert.assertEquals("0秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s秒"))
        Assert.assertEquals("0分钟", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟"))
        Assert.assertEquals("0分钟", Datex.formatDuration(0L, "%d?天%h?小时%m分钟"))
        Assert.assertEquals("0小时", Datex.formatDuration(0L, "%d?天%h?小时"))
        Assert.assertEquals("0小时", Datex.formatDuration(0L, "%d?天%h小时"))
        Assert.assertEquals("0天", Datex.formatDuration(0L, "%d?天"))
        Assert.assertEquals("0天", Datex.formatDuration(0L, "%d天"))

        Assert.assertEquals("0天0小时0分钟0秒0毫秒", Datex.formatDuration(0L, "%d天%h小时%m分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0小时0分钟0秒", Datex.formatDuration(0L, "%d天%h小时%m分钟%s秒"))
        Assert.assertEquals("0天0小时0分钟", Datex.formatDuration(0L, "%d天%h小时%m分钟"))
        Assert.assertEquals("0天0小时", Datex.formatDuration(0L, "%d天%h小时"))
        Assert.assertEquals("0天", Datex.formatDuration(0L, "%d天"))

        Assert.assertEquals("0小时0分钟0秒0毫秒", Datex.formatDuration(0L, "%d?天%h小时%m分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0分钟0秒0毫秒", Datex.formatDuration(0L, "%d天%h?小时%m分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0小时0秒0毫秒", Datex.formatDuration(0L, "%d天%h小时%m?分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0小时0分钟0毫秒", Datex.formatDuration(0L, "%d天%h小时%m分钟%s?秒%ms毫秒"))
        Assert.assertEquals("0天0小时0分钟0秒", Datex.formatDuration(0L, "%d天%h小时%m分钟%s秒%ms?毫秒"))

        Assert.assertEquals("0分钟0秒0毫秒", Datex.formatDuration(0L, "%d?天%h?小时%m分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0秒0毫秒", Datex.formatDuration(0L, "%d天%h?小时%m?分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0小时0毫秒", Datex.formatDuration(0L, "%d天%h小时%m?分钟%s?秒%ms毫秒"))
        Assert.assertEquals("0天0小时0分钟", Datex.formatDuration(0L, "%d天%h小时%m分钟%s?秒%ms?毫秒"))

        Assert.assertEquals("0秒0毫秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s秒%ms毫秒"))
        Assert.assertEquals("0天0毫秒", Datex.formatDuration(0L, "%d天%h?小时%m?分钟%s?秒%ms毫秒"))
        Assert.assertEquals("0天0小时", Datex.formatDuration(0L, "%d天%h小时%m?分钟%s?秒%ms?毫秒"))

        Assert.assertEquals("0毫秒", Datex.formatDuration(0L, "%d?天%h?小时%m?分钟%s?秒%ms毫秒"))
        Assert.assertEquals("0天", Datex.formatDuration(0L, "%d天%h?小时%m?分钟%s?秒%ms?毫秒"))

        Assert.assertEquals("0 天 0 小时 0 分钟 0 秒 0 毫秒", Datex.formatDuration(0L, "%d 天 %h 小时 %m 分钟 %s 秒 %ms 毫秒"))

        // millisecond
        Assert.assertEquals("0s", Datex.formatDuration(0L, "%d?d %h?h %m?m %s?s"))
        Assert.assertEquals("0s", Datex.formatDuration(-10L, "%d?d %h?h %m?m %s?s"))
        Assert.assertEquals("590ms", Datex.formatDuration(590L, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("0s", Datex.formatDuration(590L, "%d?d %h?h %m?m %s?s"))
        Assert.assertEquals("1590ms", Datex.formatDuration(1590L, "%ms?ms"))
        Assert.assertEquals("1s 90ms", Datex.formatDuration(1090L, "%ss %ms?ms"))
        Assert.assertEquals("1s 090ms", Datex.formatDuration(1090L, "%ss %MS?ms"))

        // second
        Assert.assertEquals("3s", Datex.formatDuration(oneSecondMilliseconds * 3, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("3s 590ms", Datex.formatDuration(oneSecondMilliseconds * 3 + 590, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("3s", Datex.formatDuration(oneSecondMilliseconds * 3 + 590, "%d?d %h?h %m?m %s?s"))

        // minute
        Assert.assertEquals("3m", Datex.formatDuration(oneMinuteMilliseconds * 3, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("3m 23s", Datex.formatDuration(oneMinuteMilliseconds * 3 + oneSecondMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("3m 23s 467ms", Datex.formatDuration(oneMinuteMilliseconds * 3 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("3m 467ms", Datex.formatDuration(oneMinuteMilliseconds * 3 + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("3m", Datex.formatDuration(oneMinuteMilliseconds * 3 + 467, "%d?d %h?h %m?m %s?s"))

        // hour
        Assert.assertEquals("1h", Datex.formatDuration(oneHourMilliseconds, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1h 23m", Datex.formatDuration(oneHourMilliseconds + oneMinuteMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1h 23m 23s", Datex.formatDuration(oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1h 23s", Datex.formatDuration(oneHourMilliseconds + oneSecondMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1h 23m 23s 467ms", Datex.formatDuration(oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1h 467ms", Datex.formatDuration(oneHourMilliseconds + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1h", Datex.formatDuration(oneHourMilliseconds + 467, "%d?d %h?h %m?m %s?s"))

        // day
        Assert.assertEquals("1d", Datex.formatDuration(oneDayMilliseconds, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 1h 23m", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 1h 23m 23s", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 1h 23s", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneSecondMilliseconds * 23, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 1h 23m 23s 467ms", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 1h 467ms", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 467ms", Datex.formatDuration(oneDayMilliseconds + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d", Datex.formatDuration(oneDayMilliseconds + 467, "%d?d %h?h %m?m %s?s"))

        Assert.assertEquals("1d 1h 23m 23s 467ms", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("1d 1h 23m 23s", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h %m?m %s?s"))
        Assert.assertEquals("1d 1h 23m", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h %m?m"))
        Assert.assertEquals("1d 1h", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d %h?h"))
        Assert.assertEquals("1d", Datex.formatDuration(oneDayMilliseconds + oneHourMilliseconds + oneMinuteMilliseconds * 23 + oneSecondMilliseconds * 23 + 467, "%d?d"))
        Assert.assertEquals("0ms", Datex.formatDuration(0L, "%d?d %h?h %m?m %s?s %ms?ms"))
        Assert.assertEquals("0s", Datex.formatDuration(0L, "%d?d %h?h %m?m %s?s"))
        Assert.assertEquals("0m", Datex.formatDuration(0L, "%d?d %h?h %m?m"))
        Assert.assertEquals("0h", Datex.formatDuration(0L, "%d?d %h?h"))
        Assert.assertEquals("0d", Datex.formatDuration(0L, "%d?d"))

        Assert.assertEquals("00:00:00", Datex.formatDuration(0L, "%H:%M:%S"))
        Assert.assertEquals("00:00:05", Datex.formatDuration(oneSecondMilliseconds * 5.toLong(), "%H:%M:%S"))
        Assert.assertEquals("00:00:59", Datex.formatDuration(oneSecondMilliseconds * 59.toLong(), "%H:%M:%S"))
        Assert.assertEquals("00:01:00", Datex.formatDuration(oneMinuteMilliseconds, "%H:%M:%S"))
        Assert.assertEquals("00:01:04", Datex.formatDuration(oneMinuteMilliseconds + (oneSecondMilliseconds * 4), "%H:%M:%S"))
        Assert.assertEquals("01:00:00", Datex.formatDuration(oneHourMilliseconds, "%H:%M:%S"))
        Assert.assertEquals("01:00:04", Datex.formatDuration(oneHourMilliseconds + (oneSecondMilliseconds * 4), "%H:%M:%S"))
        Assert.assertEquals("01:18:04", Datex.formatDuration(oneHourMilliseconds + oneMinuteMilliseconds * 18 + (oneSecondMilliseconds * 4), "%H:%M:%S"))
        Assert.assertEquals("100:18:04", Datex.formatDuration(oneHourMilliseconds * 100 + oneMinuteMilliseconds * 18 + (oneSecondMilliseconds * 4), "%H:%M:%S"))
    }
