...
class DatexTest {
    ...
    fun testFormatTimeLength() {
        ...
        Assert.assertEquals("1590ms", Datex.formatTimeLength(1590L, "%ms?ms"))
        Assert.assertEquals("1s 90ms", Datex.formatTimeLength(1090L, "%ss %ms?ms"))
        Assert.assertEquals("1s 090ms", Datex.formatTimeLength(1090L, "%ss %MS?ms"))
