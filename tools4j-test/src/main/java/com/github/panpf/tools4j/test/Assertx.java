...
public class Assertx {
    ...
    public static void assertTwoEquals(@Nullable Object expected, @Nullable Object actual1, @Nullable Object actual2) {
    ...
    public static void assertThrow(@Nullable String message, @Nullable Class<? extends Throwable> expectedTrowType, @NotNull Runnable block) {
        try {
            block.run();
            StringBuilder builder = new StringBuilder();
