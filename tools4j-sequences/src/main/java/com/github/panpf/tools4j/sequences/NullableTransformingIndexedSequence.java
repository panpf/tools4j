...
import com.github.panpf.tools4j.common.NullableIndexedTransformer;
...
public class NullableTransformingIndexedSequence<T, R> implements Sequence<R> {
    ...
    public NullableTransformingIndexedSequence(@Nullable Sequence<T> sequence, @NotNull NullableIndexedTransformer<T, R> transformer) {
